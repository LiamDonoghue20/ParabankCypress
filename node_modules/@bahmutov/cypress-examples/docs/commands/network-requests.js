...
describe('Network Requests', () => {
  before(() => {
    cy.visit(
      'https://glebbahmutov.com/cypress-examples/9.0.0/commands/network-requests',
    )
  })
  ...
  it('cy.request() - confirm the response header', () => {
